...
QWidget *WidgetFactory::createWidget2(const QString &name, QWidget *parentWidget) const
{
    CustomWidgetFactoryMap::const_iterator it = m_customFactory.constFind(name);
