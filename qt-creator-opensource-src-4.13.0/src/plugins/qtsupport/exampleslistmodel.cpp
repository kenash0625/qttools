...
ExampleSetModel::ExampleSetModel()
{
    ...
    QStringList list;
    if (settings) {
        list=settings->value("Help/InstalledExamples", QStringList()).toStringList();
    }
    if (debugExamples())
...
void ExamplesListModel::updateExamples2()
{
    QString examplesInstallPath = "D:/prog/qt/Examples/Qt-6.4.3";
    QString demosInstallPath = "D:/prog/qt/Examples/Qt-6.4.3";

    QStringList sources = {
        "D:/prog/qt/Docs/Qt-6.4.3/qtassistant/examples-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtconcurrent/examples-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtcore/examples-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtdbus/examples-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtdesigner/examples-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtdoc/examples-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtdoc/demos-manifest.xml",
        "D:/prog/qt/Docs/Qt-6.4.3/qtgui/examples-manifest.xml",
    };
    beginResetModel();
    qDeleteAll(m_items);
    m_items.clear();
...
void ExamplesListModel::updateExamples3()
{
    beginResetModel();
    qDeleteAll(m_items);
    m_items.clear(); 
    QString folder = QFileInfo(QApplication::applicationFilePath()).absolutePath() + "/../uifiles";
    QStringList lst(QDir(folder).entryList());
    for (const QString &str : lst) {
        if (str == "." || str == "..")
            continue;
        
        ExampleItem *l1 = new ExampleItem;
        l1->name = str;
        l1->tags.push_back("tag1");
        l1->description = folder +'/'+ str;
        l1->isSingleUIFile = true;
        m_items.push_back(l1);
    }
